...
\ref{fig:state_machines_instr_a} for the program shown in
\ref{fig:broken_privatize}.  The list of relevant addresses for this
state machine will contain \verb|global1|, \verb|fallback| and
...
suggests an alternative fix with two critical sections: one
