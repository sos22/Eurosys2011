...
\begin{figure*}[t]
\subfigure[Instruction A]{\includegraphics[scale=0.3]{diagrams/statementA.pdf}
  \label{fig:state_machines:a}}
\subfigure[Instruction B]{\includegraphics[scale=0.3]{diagrams/statementB.pdf}
  \label{fig:state_machines:b}}
\subfigure[Instruction C]{\includegraphics[scale=0.3]{diagrams/statementC.pdf}
  \label{fig:state_machines:c}}
\subfigure[Instruction D]{\includegraphics[scale=0.3]{diagrams/statementD.pdf}
...
\subfigure[Instruction J]{\includegraphics[scale=0.3]{diagrams/statementJ.pdf}
