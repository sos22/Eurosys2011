...
\S\ref{sect:indirect_branches})\footnote{We also impose a limit on the
  number of instructions examined, but this was not reached in any of
  our experiments.}.  We then eliminate any loops in the graph using a
scheme described in \S\ref{sect:loops} and so produce a DAG of
