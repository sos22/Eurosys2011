...
use of such information when it is available.
...
to eliminate the loop.  We choose edges to remove based on two
heuristics.  First, we try not to remove any edges which are
...
static instruction issues at most one dynamic load.
